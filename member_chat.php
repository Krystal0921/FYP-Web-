        ...
        <div class="wrapper">
            ...
            <section class="users">
                ...
                <div class="users-list">
                    <?php
                    // $stmtFetchUsers = $conn->prepare("SELECT DISTINCT c.receiverId, u.uName FROM chat c
                    //                         JOIN user u ON c.receiverId = u.userId
                    //                         WHERE c.senderId = ?");
                    // $stmtFetchUsers->bind_param("s", $userId);
                    // $stmtFetchUsers->execute();
                    // $resultUsers = $stmtFetchUsers->get_result();

                    // if ($resultUsers->num_rows > 0) {
                    //     while ($rowUser = $resultUsers->fetch_assoc()) {
                    //         echo '<a href="#" data-userId="' . $rowUser['receiverId'] . '">
                    //     <div class="content">
                    //         <img src="user_icon/default-profile-picture.jpg" alt="">
                    //         <div class="details">
                    //             <span>' . $rowUser['uName'] . '</span>
            ...
            <section class="chat-area">
                ...
                <form action="#" class="typing-area" id="messageForm">
                    <input type="text" id="messageInput" placeholder="Type a message here..." value="<?php echo isset($_GET['fromApplyList']) && $_GET['fromApplyList'] === 'true' ? 'hello' : ''; ?>">
                    <button type="button" id="sendMessageBtn"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                </form>
            </section>
        </div>
    </div>
