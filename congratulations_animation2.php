    ...
    ?>
        ...
        <div class="congrats">
            ...
            <div class="button-container">
                <button onclick="window.location.href='quiz.php?lessonId=<?php echo $lessonId; ?>'" class="btn btn-primary me-2">Try Again</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="window.location.href='lesson_section.php?lessonId=<?php echo $lessonId; ?>&score=<?php echo $score; ?>'" class="btn btn-primary">Home Page</button>
            </div>
