...
<body>
    ...
    <div class="ai-body">
        <div class="ai-container">
            <form action="section_ai.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="image-container">
                            <div class="result-message result-correct" style="color: green; font-weight: bold; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                ...
                                <div style="display: flex; justify-content: space-between;">
                                    <a href="section_ai.php" class="btn btn-primary ai" style="margin-right: 10px;">Try
                                        again</a>
                                    <a href="lesson.php" class="btn btn-primary ai">Back to Lesson</a>
                                </div>
                            </div>
                        </div>
