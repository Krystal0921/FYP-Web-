                ...
                <div class="col-md-8 mx-auto text-center">
                    ...
                    if (isset($_POST['finishButton'])) {
                                ...
                                if ($responseData['success']) {
                                    ...
                                    $location = "feedback.php?lessonId=" . $lessonId . "&sectionId=" . $sectionId;
                                    header("Location: " . $location);
                                } else {
                                    $errorMsg = $responseData['msg'];
                                    $errorCode = $responseData['code'];
                                    if ($errorCode == 1) {
                                        $location = "lesson_section.php?lessonId=" . $lessonId;
                                        header("Location: " . $location);
                            }
                            curl_close($curl);
                        }
                    ...
                    <form
                        action="lesson_section_content.php?lessonId=<?php echo $lessonId; ?>&sectionId=<?php echo $sectionId; ?>"
                        method="POST">
    ...
    <script>
        ...
        function previousMedia() {
            if (currentIndex > 0) {
                ...
                var location = "lesson_section.php?lessonId=" + <?php echo json_encode($lessonId); ?>;
